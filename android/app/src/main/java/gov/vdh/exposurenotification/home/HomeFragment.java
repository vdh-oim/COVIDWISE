...
public class HomeFragment extends Fragment {
  ...
  @IntDef({TAB_EXPOSURES, TAB_NOTIFY, TAB_VIRTUAL_AGENT, TAB_DEBUG })
  @interface TabName {}

  //static final int TAB_HOME =0;
  static final int TAB_EXPOSURES = 0;
  static final int TAB_NOTIFY = 1;
  static final int TAB_DEBUG = 3;
  static final int TAB_VIRTUAL_AGENT =2;
 ...
 /*   tabLayout.getTabAt(TAB_HOME).setIcon(R.drawable.home);
    tabLayout.getTabAt(TAB_HOME).setText(R.string.home_tab);*/ // Disbaled 12 june

    tabLayout.getTabAt(TAB_EXPOSURES).setIcon(R.drawable.ic_exclamation_circle);
    ...
    tabLayout.getTabAt(TAB_VIRTUAL_AGENT).setIcon(R.drawable.ic_virtual);
    tabLayout.getTabAt(TAB_VIRTUAL_AGENT).setText(R.string.home_tab_virtual_agent);
    //Tech mangerial HR
  }
