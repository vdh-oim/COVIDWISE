...
import gov.vdh.exposurenotification.nearby.StateUpdatedWorker;
import gov.vdh.exposurenotification.onboarding.OnboardingPermissionFragment;
import gov.vdh.exposurenotification.onboarding.OnboardingStartFragment;
import gov.vdh.exposurenotification.storage.ExposureNotificationSharedPreferences;
import gov.vdh.exposurenotification.storage.ExposureNotificationSharedPreferences.OnboardingStatus;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      if (prefs.getOnboardedState() == OnboardingStatus.UNKNOWN) {
        ...
        if (prefs.getFirstOnboardingStatus(false)){
          prefs.setFirstOnboardingStatus(true);
        }
        getSupportFragmentManager()
            .beginTransaction()
