...
public class NotifyHomeFragment extends Fragment {
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
   ...
   /* if (startApiButton.isEnabled()){
      exposureNotificationViewModel.scheduleSync();
    }*/
    ...
    PositiveDiagnosisEntityAdapter notifyViewAdapter = new PositiveDiagnosisEntityAdapter(
        positiveDiagnosisEntity -> startActivity(ShareDiagnosisActivity
            .newIntentForViewFlow(requireContext(), positiveDiagnosisEntity)));
    ...
    TextView t2 = (TextView) view.findViewById(R.id.fragment_notify_learnmore);
  ...
  private void refreshUiForEnabled(Boolean currentlyEnabled) {
    ...
    if (currentlyEnabled) {
      ...
      ExposureNotificationSharedPreferences sharedPrefs =
          new ExposureNotificationSharedPreferences(requireContext());
      sharedPrefs.setOnboardedState(false);
    }
    rootView
