...
import gov.vdh.exposurenotification.debug.proto.SignatureInfo;
import gov.vdh.exposurenotification.debug.proto.TEKSignature;
...
public class KeyFileWriter {
  ...
  private static List<gov.vdh.exposurenotification.debug.proto.TemporaryExposureKey>
  toProto(List<TemporaryExposureKey> keys) {
    List<gov.vdh.exposurenotification.debug.proto.TemporaryExposureKey> protos =
        new ArrayList<>();
    for (TemporaryExposureKey k : keys) {
      protos.add(
          gov.vdh.exposurenotification.debug.proto.TemporaryExposureKey.newBuilder()
